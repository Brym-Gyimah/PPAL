...
class ATSSQualityOTAHead(ATSSHead):
    def __init__(self,
                 num_classes,
                 in_channels,
                 stacked_convs=4,
                 ...
                 init_cfg=dict(
                     ...
                     override=dict(
                         ...
                         std=0.01,
                         bias_prob=0.01)),
                # base_momentum=0.999 update this to OTA variables
                # quality_xi=0.6 update this to OTA variables
                 **kwargs):
       ...
       # self.quality_xi = quality_xi update this to OTA variables
       ...
       # self.base_momentum = base_momentum update these to OTA variables
